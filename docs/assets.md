...
Комплект для Godot, Android, iOS, Windows, macOS и браузерного контроллера:
[assets/icons/README.md](../assets/icons/README.md). Исходные генерации и промпты
сохранены в `assets/icons/source/`; размеры и платформенные контейнеры
воспроизводятся скриптом `tools/icons/build_icons.gd`.
...
Use case: stylized-concept. Asset type: production albedo texture for a circular felt game arena, square 2048px image. Create a perfectly top-down orthographic flat circular Kyrgyz shyrdak felt rug, centered full circle fills 95% of image. Beautiful handmade wool felt with visibly fine fibers and embroidered stitching, authentic flowing ram-horn ornamental motifs, concentric rings, burgundy terracotta and warm cream main field, thin dark petrol teal rings and ochre seams. Center is a simple cream 12-point sun medallion about 18 percent diameter, broad middle playing area with restrained low-contrast felt patch ornaments, richly embroidered outer border. Background outside circular rug is dark charcoal. Flat even lighting, no directional shadows, no perspective, no room, no objects, no figures, no flame, no UI, no lettering. This will be mapped directly onto a 3D game board, not a screenshot. Rich tactile artisan texture, high end stop motion miniature material.
